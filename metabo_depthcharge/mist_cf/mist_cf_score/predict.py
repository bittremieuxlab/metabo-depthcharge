...
def get_args():
    ...
    parser.add_argument("--batch-size", default=8, action="store", type=int)
    parser.add_argument("--save-name", default=None)
    parser.add_argument("--save-dir", default=None)
    parser.add_argument(
        "--pred-label", default="data/canopus_train/pred_labels/pred_label.tsv"
    )
    parser.add_argument("--dataset-name", default="canopus_train")
    parser.add_argument("--checkpoint-pth", required=True)
    parser.add_argument("--subform-dir", type=str, default="")
    parser.add_argument(
        "--output-num",
        type=int,
        default=None,
        help="Number of top candidates to keep per spectrum",
    )
...
def predict():
    ...
    common.get_data_dir(dataset_name)
    ...
    logging.info(f"Loaded model from {best_checkpoint}")
